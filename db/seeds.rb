...
Event.create('title': 'tincidunt', 'user_id': 1, 'duedate': DateTime.new(2017, 6, 01), 'spots': 10, 'place': 'Jakiesmiejsce1')
Event.create('title': 'et, commodo at,', 'user_id': 8, 'duedate': DateTime.new(2017, 6, 14), 'spots': 20, 'place': 'Jakiesmiejsce2')
Event.create('title': 'a,', 'user_id': 7, 'duedate': DateTime.new(2017, 6, 22), 'spots': 10, 'place': 'Jakiesmiejsce3')
Event.create('title': 'elit,', 'user_id': 9, 'duedate': DateTime.new(2017, 7, 05), 'spots': 10, 'place': 'Jakiesmiejsce4')
Event.create('title': 'mauris. Morbi', 'user_id': 10, 'duedate': DateTime.new(2017, 7, 14), 'spots': 10, 'place': 'Jakiesmiejsce5')
Event.create('title': 'enim. Curabitur massa.', 'user_id': 4, 'duedate': DateTime.new(2017, 8, 23), 'spots': 10, 'place': 'Jakiesmiejsce6')
Event.create('title': 'amet', 'user_id': 8, 'duedate': DateTime.new(2017, 8, 27), 'spots': 10, 'place': 'Jakiesmiejsce7')
Event.create('title': 'penatibus et', 'user_id': 3, 'duedate': DateTime.new(2017, 9, 11), 'spots': 10, 'place': 'Jakiesmiejsce8')
Event.create('title': 'pede. Cum', 'user_id': 1, 'duedate': DateTime.new(2017, 10, 20), 'spots': 10, 'place': 'Jakiesmiejsce9')
Event.create('title': 'eget', 'user_id': 6, 'duedate': DateTime.new(2017, 11, 15), 'spots': 16, 'place': 'Jakiesmiejsce10')
