...
subject { 
    described_class.new(start_date: DateTime.now, end_date: DateTime.now+1.week, care_type: "1", employee_id: "2") 
}
...
describe "Validations" do
  ...
  it "is not valid without a care_type" do
    subject.care_type = nil
    expect(subject).to_not be_valid
  end
